      ...
      >
        ...
        <View style={s.card}>
          ...
          <View style={s.field}>
            ...
            <TouchableOpacity style={[s.input, s.pickerBtn]} onPress={() => setTypeOpen(!typeOpen)} activeOpacity={0.7}>
          ...
          <TouchableOpacity style={s.checkRow} onPress={() => setAgreed(!agreed)} activeOpacity={0.7}>
            <View style={[s.checkbox, agreed && s.checkboxActive]}>{agreed && <Text style={s.checkmark}>✓</Text>}</View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            {loading ? <ActivityIndicator color="#fff" /> : <Text style={s.btnText}>Create Investor Account →</Text>}
          </TouchableOpacity>
